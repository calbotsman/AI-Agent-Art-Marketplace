...
- 2 bullets for why this profile best matches the round objective.

## Loop Context
- min: 3, target: 3, max: 4

## Handoff to Strategy
- Strategy must decide next bullet 1
- Strategy must decide next bullet 2
- Strategy must decide next bullet 3
