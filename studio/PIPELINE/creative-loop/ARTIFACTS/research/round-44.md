...
## Loop Context
- Min reviews: 3, Target acceptance review: 3, Max reviews: 4

## Handoff to Strategy
- Strategy must refine the problem statement to be concise and actionable.
- Strategy must identify key market trends and consumer insights relevant to Sol Vida packaging.
- Strategy must propose specific visual and thematic directions for the packaging.