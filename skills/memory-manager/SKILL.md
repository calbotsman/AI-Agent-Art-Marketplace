...
```bash
/Users/calbotsman/clawd/skills/memory-manager/init.sh
```
...
```bash
/Users/calbotsman/clawd/skills/memory-manager/detect.sh
```
...
```bash
/Users/calbotsman/clawd/skills/memory-manager/organize.sh
```
...
/Users/calbotsman/clawd/skills/memory-manager/search.sh episodic "launched skill"

# Search semantic (what I know)
/Users/calbotsman/clawd/skills/memory-manager/search.sh semantic "moltbook"

# Search procedural (how to)
/Users/calbotsman/clawd/skills/memory-manager/search.sh procedural "validation"

# Search all
/Users/calbotsman/clawd/skills/memory-manager/search.sh all "compression"
```
...
1. Run: /Users/calbotsman/clawd/skills/memory-manager/detect.sh
2. If warning/critical: /Users/calbotsman/clawd/skills/memory-manager/snapshot.sh
3. Daily at 23:00: /Users/calbotsman/clawd/skills/memory-manager/organize.sh
```
...
```bash
# Move episodic entry
/Users/calbotsman/clawd/skills/memory-manager/categorize.sh episodic "2026-01-31: Launched Memory Manager"

# Extract semantic knowledge
/Users/calbotsman/clawd/skills/memory-manager/categorize.sh semantic "moltbook" "Moltbook is the social network for AI agents..."

# Document procedure
/Users/calbotsman/clawd/skills/memory-manager/categorize.sh procedural "skill-launch" "1. Validate idea\n2. Build MVP\n3. Launch on Moltbook..."
```
...
/Users/calbotsman/clawd/skills/memory-manager/stats.sh
```
...
- These scripts can move/copy files under your OpenClaw workspace `memory/` directory. Review before running.
- Never run organization/migration scripts unless you’re in the correct workspace and you have a backup (snapshots help, but don’t replace git/backups).
