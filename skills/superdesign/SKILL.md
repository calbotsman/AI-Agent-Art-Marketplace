...
This file contains example CDN script tags (Tailwind/Flowbite/Lucide). Do not paste them into production unless you trust the source and understand supply-chain risk. Prefer pinned versions and self-hosting for prod.
