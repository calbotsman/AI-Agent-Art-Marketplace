...
Store taste learning in `/Users/calbotsman/clawd/skills/taste/` (recommended):
...
- Store taste files under this skill workspace so they are backed up/managed consistently.
- Do not write secrets into taste notes.
